...
/*GRAPHICS PIPELINE.
 * Takes in a vertex data[] -> vertex shader -> shape assembly -> geometry shader -> rasterization
...
int main (int argc, char *argv[]) {
    ...
    GLFWwindow* window = glfwCreateWindow(800, 800, "ColourBlindness", NULL, NULL);
    ...
    graphics::VBO VBO1(vertices, sizeof(vertices));
    // Generates Element Buffer Object and links it to indices
    graphics::EBO EBO1(indices, sizeof(indices));
